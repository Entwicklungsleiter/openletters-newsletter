    ...
    <tr>
        <td class="small" valign="bottom">
            <select name="title" style="margin-bottom:7px;">
                ...
                <option value="Frau" <?php if ($params['title'] == "Frau"): echo "selected"; endif;?> >i18n(form_word_misses)</option>
                <option value="Herr" <?php if ($params['title'] == "Herr"): echo "selected"; endif;?> >i18n(form_word_mister)</option>
            </select>
        </td>
        <td class="small">&nbsp;</td>
    </tr>

...
?>
    <script language="javascript" type="text/javascript" src="<?php echo ROOT_PATH; ?>admin/vendor/tinymce/tiny_mce.js"></script>
    <script language="javascript" type="text/javascript">
        ...
        function ajaxfilemanager(field_name, url, type, win) {
            ...
            var ajaxfilemanagerurl = "<?php echo ROOT_PATH; ?>admin/vendor/tinymce/plugins/ajaxfilemanager/ajaxfilemanager.php"
            switch (type) {
                case "image": break;
                case "media": break;
                case "flash": break;
